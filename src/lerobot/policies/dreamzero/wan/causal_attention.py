...
# Ported from NVIDIA DreamZero: groot/vla/model/dreamzero/modules/wan2_1_attention.py
...
try:
    ...
    from .cudnn_attention import DotProductAttention  # lazy: transformer_engine optional
